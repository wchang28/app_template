...
ReactDOM.render(<TypeAhead dropDownContentClass={AddressMatch} identity={(o) => o} suggestionEngine={engine} minCharToSearch={3} onQueryChanged={onQueryChanged}/>, document.getElementById('test'));