...
promise.done(function() {
	...
	ReactDOM.render(<TypeAhead dropDownContentClass={MyMatch} identity={(o) => o.Id} suggestionEngine={engine} minCharToSearch={2} onQueryChanged={onQueryChanged} placeholder="Type something" roundSize="medium"/>, document.getElementById('test'));
}).fail(function() {
