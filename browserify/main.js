...
ReactDOM.render(<TypeAhead dropDownContentClass={AddressMatch} identity={(o) => o} suggestionEngine={engine} minCharToSearch={1} onQueryChanged={onQueryChanged} placeholder="Type an address here" roundSize="medium"/>, document.getElementById('test'));